...
* 🔊 **Text-to-Speech (Voice Output):** Real-time voice reading of AI responses via native Speech Synthesis in Catalan/Spanish, featuring a top bar toggle (`🔊/🔇`) and individual `🔊 Escolta` buttons on each message card.
